...
public class BackStackTest extends AndroidTestCase {
    public void test() {
        ...
        final BackStack.Item item1 = new BackStack.Item(3, Frequency.newChannelFrequency(475, 133, 0));
        final BackStack.Item item2 = new BackStack.Item(5, Frequency.newCtcssFrequency(34, 5));
